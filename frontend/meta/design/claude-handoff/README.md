...
**Find the primary design file under `pleromanet/project/` and read it top to bottom.** The chat transcripts will tell you which file the user was last iterating on. Then **follow its imports**: open every file it pulls in (shared components, CSS, scripts) so you understand how the pieces fit together before you start implementing.
...
- `pleromanet/README.md` — this file
- `pleromanet/chats/` — conversation transcripts (read these!)
- `pleromanet/project/` — the `PleromaNet` project files (HTML prototypes, assets, components)
